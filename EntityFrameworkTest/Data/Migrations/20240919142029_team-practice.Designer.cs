...
namespace EntityFrameworkTest.Data.Migrations
{
    ...
    [Migration("20240919142029_team-practice")]
    partial class teampractice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityFrameworkTest.Models.Player", b =>
                {
            ...
            modelBuilder.Entity("EntityFrameworkTest.Models.School", b =>
                {
            ...
            modelBuilder.Entity("EntityFrameworkTest.Models.Sponsor", b =>
                {
            ...
            modelBuilder.Entity("EntityFrameworkTest.Models.Team", b =>
                {
                    ...
                    b.Property<string>("SecretPractice")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EntityFrameworkTest.Models.Team", b =>
                {
                    b.HasOne("EntityFrameworkTest.Models.School", "School")
                        .WithMany()
            ...
            modelBuilder.Entity("SponsorTeam", b =>
                {
                    b.HasOne("EntityFrameworkTest.Models.Sponsor", null)
                        .WithMany()
                        .HasForeignKey("SponsorsSponsorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityFrameworkTest.Models.Team", null)
                        .WithMany()
